...
import 'package:aquatic_xpress_shipping/screens/user/profile/components/InProcess_Orders/ups.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          _currentIndex == 0
              ? "InProcess UPS Orders"
              : "InProcess Fedex Orders",
        ),
      ),
      body: Stack(
        children: [
          TabBarView(
            ...
            children: <Widget>[InProcessUPSOrders(value: 0,), 
            // InProcessFedexOrders(value:1)
            ],
          ),
          Positioned(
            bottom: 0,
