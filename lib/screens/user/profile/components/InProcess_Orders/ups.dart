...
class InProcessUPSOrders extends StatefulWidget {
  final value;
  const InProcessUPSOrders({Key? key, @required this.value}) : super(key: key);

  @override
  _InProcessUPSOrdersState createState() => _InProcessUPSOrdersState();
}

class _InProcessUPSOrdersState extends State<InProcessUPSOrders> {
  ...
  getUsers() async {
    ...
    String ?link =
        "${getCloudUrl()}/api/ShipmentOrder/unpaidOrdersInprocess";
